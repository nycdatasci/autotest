...
#define TESTTHAT_DISABLED_FUNCTION \
  static void TESTTHAT_TOKEN_PASTE(autotest_disabled_test_, __LINE__) ()

/**
 * Conditionally enable or disable 'autotest' + 'Catch'.
 * Force 'autotest' to be enabled by defining TESTTHAT_ENABLED.
 * Force 'autotest' to be disabled by defining TESTTHAT_DISABLED.
 * TESTTHAT_DISABLED takes precedence.
 * 'autotest' is disabled on Solaris by default.
 */
...
{
  static autotest::r_ostream instance;
  return instance;
}
...
extern "C" SEXP run_autotest_tests() {
  bool success = autotest::run_tests();
