...
#'
#' autotest is a new testing framework for R that is easy learn and use,
#' and integrates with your existing workflow.
#'
#' @section Options:
#' - `autotest.use_colours`: Should the output be coloured? (Default:
#' `TRUE`).
#'
#' - `autotest.summary.max_reports`: The maximum number of detailed test
#' reports printed for the summary reporter (default: 15).
#'
#' - `autotest.summary.omit_dots`: Omit progress dots in the summary reporter
#' (default: `FALSE`).
#'
#' @docType package
#' @name autotest
#' @references Wickham, H (2011). autotest: Get Started with Testing.
#' \strong{The R Journal} \emph{3/1} 5-10.
#' \url{http://journal.r-project.org/archive/2011-1/RJournal_2011-1_Wickham.pdf}
#'
#' \url{https://github.com/hadley/autotest}
#'
